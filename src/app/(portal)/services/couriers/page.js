          ...
          >
            <Stack spacing={3} sx={{ justifyContent: "center", px: 5 }}>
              ...
              <Typography
                ...
                sx={{ color: theme.palette.text.secondary }}
              >
                The FedEx Express delivery service was founded as &quot;Federal
                Express&quot; in 1971 in a small town in Arkansas, United
                States. From there FedEx Express has grown consistently and now
                has over 280,000 employees.
              </Typography>
              ...
              >
                ...
                services now have a fleet of over 671 aircraft and 43,000 road
                vehicles across the world. They also have 1,200 service centres
                across the globe. Approximately 3.1 million packages are
                delivered by FedEx Express worldwide each day.
              </Typography>
              ...
              <Typography
                ...
                sx={{ color: theme.palette.text.secondary }}
              >
                Send a parcel with FedEx from just £3.65 exc VAT today. Get your
                FedEx Express quote now with our{" "}
                <Box
                  component="span"
                  sx={{
          ...
          >
            ...
            <Stack spacing={3} py={4} px={6}>
              ...
              <Typography
                ...
                sx={{ color: theme.palette.text.secondary }}
              >
                Looking for professional courier tracking at no extra cost? Get
                free parcel tracking on all FedEx delivery services with
                Parcel2Go.
              </Typography>
              <Box>
                <UIButton
              ...
              <SwiperSlide key={index}>
                ...
                >
                  <Box
                    component="img"
                    src={
                      card.image && card.image.src ? card.image.src : card.image
                    }
                    alt={card.title}
                    sx={{
                      width: "100%",
